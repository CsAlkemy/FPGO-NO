const en = {
  ...
  label: {
    ...
    multipleCustomersCanBeAdded: "Multiple customers can be added",
    removeItem: "Remove Item",
    searchCustomersByNameOrPhoneNo: "Search customers by name or phone number",
    sortBy: "Sort by",
    administration: "Administration",
    purchase: "Purchase",
    sendInvoice: "Send Invoice",
    orderLogCustomerInformationUpdated: "Customer Information Updated",
    orderLogInvoiceOrderExported: "Invoice Sent",
    customerTimelineInvoiceOrderExported: "Order Sent by Invoice",
    clientTimelineCustomerInformationUpdated: "Customer Information Updated",
    clientTimelineInvoiceOrderExported: "Order Sent by Invoice",
    refundPending: "Refund Pending",
    searchCustomersByPhoneNo: "Search Customers by Phone No",
    ...
    selectDateRangeToDownloadVatReport:
      "Select date range to download VAT report",
    accountCode: "Account Code",
    refundReference: "Refund Reference",
    vatCode: "VAT Code",
    differentAccountCode: "Different account code",
    client: "Client",
    january: "January",
    february: "February",
    march: "March",
  ...
  message: {
    ...
    orderExportedToApticSuccessfully: "Order Sent Successfully",
  },
  validation: {
