    ...
    return (
        ...
        >
            <div className="relative z-10 flex w-11/12 sm:w-auto min-h-auto max-h-3xl rounded-xl bg-white sm:rounded-2xl overflow-hidden h-661 sm:custom-drop-shadow remove-mui-paper-transition">
                ...
                <Box className="relative hidden md:flex flex-auto mt0-5 items-end pt-36 pb-36 pr-112 pl-20 overflow-hidden bg-hero-login h-full w-full bg-no-repeat bg-cover"
                    style={{
                ...
                >
                    <div className="z-10 relative w-full max-w-2xl">
                        <div className="leading-none text-white">
                            ...
                            <div className="text-52 leading-10 font-bold">{t("label:frontGo")}</div>
                        </div>
