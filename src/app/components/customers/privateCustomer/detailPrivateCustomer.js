...
const detailPrivateCustomer = (onSubmit = () => { }) => {
  ...
  useEffect(() => {
    ...
    // PrivateDefaultValue.billingPhoneNumber =
    //   info?.addressDetails?.billing?.countryCode &&
    //     info?.addressDetails?.billing?.msisdn
    //     ? info.addressDetails.billing.countryCode +
    //     info.addressDetails.billing.msisdn
    //     : "";
    // PrivateDefaultValue.billingEmail = info?.addressDetails?.billing?.email
    //   ? info.addressDetails.billing.email
    //   : "";
    ...
    // PrivateDefaultValue.shippingPhoneNumber =
    //   info?.addressesDetails?.shipping?.countryCode &&
    //     info.addressesDetails.shipping?.msisdn
    //     ? info.addressesDetails.shipping?.countryCode +
    //     info.addressesDetails.shipping?.msisdn
    //     : "";
    // PrivateDefaultValue.shippingEmail = info?.addressesDetails?.shipping?.email
    //   ? info.addressesDetails.shipping?.email
    //   : "";
