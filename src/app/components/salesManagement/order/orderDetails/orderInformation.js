...
import { Autocomplete, Backdrop, CircularProgress, Hidden } from '@mui/material';
...
import {
  ...
  validateSchemaCreateOrderCorporate, validateSchemaCreateOrderCorporateOrderBySms,
  validateSchemaCreateOrderPrivate, validateSchemaCreateOrderPrivateOrderByEmail
} from "../../utils/helper";
...
const OrderInformation = ({info, loading} ) => {
          ...
          <div className="create-product-container mb-32 md:mb-0">
            <div className="inside-div-product">
              <div className="rounded-sm bg-white p-0 md:px-20">
                ...
                >
                  <Hidden smUp>
                    <Accordion className={`${!expandedPanelOrder ? 'bg-primary-25' : 'bg-primary-700'} mt-20 bg-primary-25 shadow-0 border-0 custom-accordion`}>
                      <AccordionSummary
                        expandIcon={
                          !expandedPanelOrder ? (
                        ...
                        id="panel2a-header"
                      >
                        <div className={`subtitle3  flex gap-10 my-auto ${!expandedPanelOrder ? 'text-MonochromeGray-700' : 'text-white'}`}>
                              ...
                              <Controller
                                ...
                                render={({ field }) => (
                                  <TextField
                                    ...
                                    disabled
                                    defaultValue={
                                      info.productList && info.productList?.[index]?.tax
                  ...
                  <Hidden smDown>
                    <div className="product-list">
                      <div className="my-10 product-list-grid-container product-list-grid-container-height bg-primary-25 subtitle3 gap-10 px-10">
                        ...
                        <div className="my-auto text-MonochromeGray-500">Qty.</div>
                          ...
                          <Controller
                            ...
                            render={({ field: { onChange, value, onBlur } }) => (
                              <DesktopDatePicker
                                ...
                                value={info?.orderDate ? prepareOrderDate(info?.orderDate) : ""}
                                // value="30 Nov, 2022"
                                required
                                disabled
                                onChange={onChange}
                                  ...
                                  <DateTimePicker
                                    ...
                                    value={
                                      info?.paymentLinkDueDate
                                        ? prepareDueDateForPaymentLink(info?.paymentLinkDueDate)
                                        // ? info?.paymentLinkDueDate
                                        : ""
                                    }
                                    required
                                    ...
                                    >
                                      ...
                                      >
                                        <div className="flex items-center">
                                          <div className="button2">{t("label:customDate")}</div>
                        ...
                        <div className="send-order-by">
                          ...
                          <div className="create-order-radio">
                            <div className="grid grid-cols-1 md:grid-cols-3 justify-between items-center gap-20 w-full md:w-3/4 my-32">
                              <Button
                                variant="outlined"
                                className={`body2 ${info.sendOrderBy.sms
                              ...
                              <Button
                                variant="outlined"
                                className={`body2 ${info.sendOrderBy.email
                                  ? "create-order-capsule-button-active-details"
                                  : "create-order-capsule-button"
                                }`}
                                startIcon={
                              ...
                              <Button
                                variant="outlined"
                                className={`body2 ${info.sendOrderBy.invoice
                                  ? "create-order-capsule-button-active-details"
                                  : "create-order-capsule-button"
                                }`}
                                startIcon={
                        ...
                        <div className="send-order-by mt-20">
                          ...
                          <div className="send-order-credit-check mt-24 mb-16">
                            ...
                            <div className="flex gap-20 w-full md:w-3/4 my-32">
                              <Button
                                variant="outlined"
                                className={`body2 ${info.creditCheck
                                  ? "create-order-capsule-button-active-details"
                                  : "create-order-capsule-button"
                                }`}
                            ...
                            <AccordionDetails className="bg-white">
                              ...
                              <div className="search-customer-order-create-type my-32">
                                ...
                                <div className="flex gap-20 w-full md:w-3/4 mb-32 mt-20">
                                  <Button
                                    variant="outlined"
                                    className={`body2 ${info?.customerDetails?.type === "Private"
                                      ? "create-order-capsule-button-active-details"
                                      : "create-order-capsule-button"
                                    }`}
                                    disabled={info.customerDetails.type !== "Private"}
                                  >
                                    {t("label:private")}
                                  </Button>
                                  <Button
                                    variant="outlined"
                                    className={`body2 ${info?.customerDetails?.type === "Corporate"
                                      ? "create-order-capsule-button-active-details"
                                      : "create-order-capsule-button"
                                    }`}
                                    disabled={
                                        ...
                                        <TextField
                                          ...
                                          defaultValue={
                                            info.customerDetails?.type === "Private"
                                              ? info.customerDetails?.personalNumber
                                                ? info.customerDetails?.personalNumber
                                                : ""
                                              : info.customerDetails?.organizationId
                                                ? info.customerDetails?.organizationId
                                                : ""
                                          }
                                        />
