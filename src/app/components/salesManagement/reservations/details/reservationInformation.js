...
const ReservationInformation = ({ info }) => {
    ...
    const formattedAddress = (info) => {
        const address = info.customerDetails?.street
            ? info.customerDetails.street + ', ' + info.customerDetails.city + ' ' + info.customerDetails.zip + ', ' + info.customerDetails.country
            : '';
    ...
    useEffect(() => {
        if( info.customerDetails?.address.street ){
            let address = info.customerDetails.address.street + ', ' + info.customerDetails.address.city + ' ' + info.customerDetails.address.zip + ', ' + info.customerDetails.address.country;
