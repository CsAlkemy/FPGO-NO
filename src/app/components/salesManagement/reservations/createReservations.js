...
const ReservationCreate = () => {
  ...
  const {
    isValid: isValidCustomer,
    dirtyFields: dirtyFieldsCustomer,
                  ...
                  <div className="no-customer-selected">
                    <div className="box customer-selection-box">
                      <h5 className="sec-sub-header">
                        {t("label:noCustomerSelected")}
                      </h5>
                      <div className="body3 text-MonochromeGray-300">
                        {t("label:selectCustomerOrCreate")}
                      </div>
                            ...
                            <TextField
                              ...
                              InputProps={{
                                endAdornment: (
                                  <InputAdornment
                                    position="end"
                                    onClick={() => setCustomDateDropDown(true)}
                                  >
                                    <EventIcon />
                                  </InputAdornment>
                                ),
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <TextField
                      ...
                      fullWidth
                      inputlabelprops={{
                        shrink: !!field.value || touchedFields.referenceNumber,
                      }}
                    />
                  )}
                />
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <TextField
                      ...
                      inputlabelprops={{
                        shrink:
                          !!field.value || touchedFields.customerReference,
                      }}
                    />
                  )}
                />
                        ...
                        <Controller
                          ...
                          render={({ field }) => (
                            <TextField
                              ...
                              inputlabelprops={{
                                shrink:
                                  !!field.value || touchedFields.billingAddress,
                              }}
                        ...
                        <Controller
                          ...
                          render={({ field }) => (
                            <TextField
                              ...
                              inputlabelprops={{
                                shrink:
                                  !!field.value || touchedFields.billingZip,
                              }}
                              required={customData.paymentMethod.includes(
                                "invoice"
                              )}
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <TextField
                            ...
                            inputlabelprops={{
                              shrink:
                                !!field.value || touchedFields.billingCity,
                            }}
                            required={customData.paymentMethod.includes(
                              "invoice"
                            )}
